package com.lzl.lzldongbaogenerator;
...
public class DongbaoGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir("E:\\分布式微服务\\FastDFS+Nginx\\代码\\mycode\\lzl-dongbao-mall-parent\\lzl-dongbao-service\\lzl-dongbao-ums\\src\\main\\java");
		gc.setAuthor("linZhaolin");
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/dongbao?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
